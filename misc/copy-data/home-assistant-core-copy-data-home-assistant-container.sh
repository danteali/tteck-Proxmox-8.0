...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/danteali/tteck-Proxmox-8.0/main/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
